...
| `S04` | thai-docx skeleton + SKILL.md | `PASS` | ครูเห็น description/ทริกของสกิลใหม่ ชัดว่าใช้ตอนไหน ไม่ชนกับ math |
| `S05` | dependency + render-env preflight | `ACTIVE` | ครูเห็นว่าถ้าขาด LibreOffice/ฟอนต์/สกิลพี่น้อง มันฟ้องบอกวิธีแก้ ไม่เงียบ |
