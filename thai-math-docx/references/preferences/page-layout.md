...
Use whenever a DOCX needs a page, table, columns, a response line, or working
space.
...
Use the named layout profiles and shared layout layer rather than recreating these
measurements in a generator.
